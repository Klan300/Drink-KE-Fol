...
has_milk(latte_soyMilk,soyMilk).
...
has_milk(mocha_soyMilk,soyMilk).
...
has_milk(caramel_mac_soyMilk,soyMilk).
...
has_milk(caramel_mac_soyMilk_decaffein,soyMilk).
...
has_syrup(latte_soyMilk,vanilla).
...
has_syrup(latte_soyMilk_decaffein,vanilla).
...
has_syrup(mocha_soyMilk,chocolate).
...
has_syrup(caramel_mac_soyMilk,caramel).
...
has_syrup(caramel_mac_soyMilk_decaffein,caramel).
...
avoid_caffein(depression, caffein).
avoid_caffein(kidney_disease, caffein).
...
has_intensity(latte_soyMilk_decaffein, 1).
...
has_intensity(mocha_soyMilk_decaffein, 1).
has_intensity(americano, 2).
has_intensity(americano_decaffein, 1).
has_intensity(esspresso, 3).
has_intensity(esspresso_decaffein, 1).
...
has_intensity(caramel_mac_soyMilk, 1).
